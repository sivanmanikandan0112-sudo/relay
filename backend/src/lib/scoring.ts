 ...
 */
function buildDailySeries(loads: { date: Date; load: number }[], start: Date, now: Date): number[] {
 ...
 */
function baselineExclusionRanges(
...
function isExcluded(date: Date, ranges: ExclusionRange[]): boolean {
